let count = 0; // 숫자가 0~9 까지 증가하는 것을 세기위한 변수
...
$(function(){       // 반복 수행할 기능, 지연시간(ms)
    ...
    // 아이디가 focus-blur인 요소에 초점이 맞춰지는 경우 
